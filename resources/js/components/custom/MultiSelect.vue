        ...
        <div class="relative" ref="dropdownRef">
            ...
            <button
                ...
                :class="{
                    ...
                    'border-gray-300 dark:border-gray-700': !isOpen && !hasError
                }"
            >
            ...
            <!-- Error Message -->
            <p v-if="hasError" class="mt-1 text-sm text-red-500 dark:text-red-400">
                {{ errorMessage }}
            </p>
...
const hasError = computed(() => {
    return props.required && selectedItems.value.length === 0
})
