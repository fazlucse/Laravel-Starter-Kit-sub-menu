        ...
        <div class="py-8 px-4 sm:px-6 lg:px-8 p-2 sm:p-4">
            <div class="max-w-7xl mx-auto">
              ...
              Self <span class="text-sm font-medium text-blue-600">({{ authUser?.name || 'You' }})</span>
                        ...
                        <p v-if="errors.request_for" class="mt-2 text-sm text-red-600 w-full">{{
                                errors.request_for
                            }}</p>
                    </div>
                    ...
                    <div class="input-wrapper">
                        <SelectInput v-model="form.leave_reason" label="Leave Reason" :options="leaveReasonOptions"
                    ...
                    <div class="input-wrapper">
                        ...
                        <p v-if="allErrors.leave_duration" class="mt-1 text-sm text-red-600">{{
                                allErrors.leave_duration
                            }}</p>
                    </div>
                    ...
                    <div v-if="leaves.length" class="mt-6 space-y-2">
                        ...
                        <div v-for="(leave, index) in leaves" :key="index"
                            ...
                            <div>
                                <p><strong>{{
                                        leave.request_for === 'self' ? 'Self' : leave.person_name || 'Other'
                                    }}</strong></p>
...
function submit() {
    ...
    form.transform((data) => ({
        ...data,
        leaves: leaves // Inject the array into the request
    })).post('/leave-request', {
        preserveScroll: true,
        onSuccess: () => {
            leaves.length = 0
