...
const props = defineProps({
    infoMaster: Object, // The record being edited
    currentType: String,
    masterTypes: Array<string>,
    parents: Array<{ id: number, name: string }>,
    parentLabel: String
});

const form = useForm({
    id: props.infoMaster.id,
    type: props.infoMaster.type,
    name: props.infoMaster.name,
    code: props.infoMaster.code,
    description: props.infoMaster.description,
    parent_id: props.infoMaster.parent_id,
});
...
// Sync parents when type changes (in case user changes type during edit)
...
const submit = () => {
    // Manual path for update using PUT
    form.put(`/info-masters/update/${props.infoMaster.id}`, {
        onSuccess: () => {
            ...
            <div class="max-w-3xl mx-auto p-2 sm:p-3">
                ...
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-orange-500 font-black uppercase tracking-widest">
                    ...
                    <form @submit.prevent="submit" class="p-8 sm:p-12 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="md:col-span-2 space-y-2">
                                ...
                                <input
                                    ...
                                    required
                                />
                                <div v-if="form.errors.name" class="text-red-500 text-[10px] font-bold uppercase mt-1 ml-2">
                                    {{ form.errors.name }}
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-end gap-6 pt-8 border-t border-gray-100 dark:border-gray-800">
                            ...
                            <button
                                ...
                                class="cursor-pointer w-full sm:w-auto bg-orange-500 hover:bg-orange-600 text-white px-10 py-4 rounded-2xl flex items-center justify-center gap-3 shadow-xl shadow-orange-500/20 active:scale-95 transition-all"
                            >
                                <Save class="w-5 h-5"/>
