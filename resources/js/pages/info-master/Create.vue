...
<template>
    <AppLayout title="Add Master Data"
        ...
        <div class="py-0 px-4 sm:px-6 lg:px-4 p-1 sm:p-4">
            <div class="max-w-7xl mx-auto p-0 sm:p-0">
...
<!--                </div>-->
                ...
                <div
                    class="bg-white dark:bg-gray-900 rounded-[1.5rem] border border-gray-200 dark:border-gray-700  dark:shadow-none overflow-hidden">
                    <form @submit.prevent="submit" class="p-4 sm:p-12 space-y-2">
                        ...
                        <div
                            class="flex flex-col sm:flex-row items-center justify-end gap-6 pt-3  border-gray-100 dark:border-gray-800">
                            <Link
                                :href="`/info-masters?type=${form.type}`"
                            ...
                            <button
                                ...
                                class="cursor-pointer w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-10 py-4 rounded flex items-center justify-center gap-3  shadow-blue-500/20 active:scale-95 transition-all"
                            >
                                <Save class="w-5 h-5"/>
