...
const formatCurrency = (amount) => amount ? new Intl.NumberFormat('en-US', {
    style: 'currency',
              ...
              ID: {{ employee.employee_id }}
                    ...
                    <div id="print_content" class="p-6 space-y-8">
                        ...
                        <div class="flex flex-col sm:flex-row items-center gap-6">
                            ...
                            <div class="text-center sm:text-left flex-1">
                                ...
                                <p v-if="employee.designation || employee.company"
                  ...
                  <span class="px-3 py-1 rounded-full text-xs font-medium"
                    ...
                    {{ employee.employment_type }}
                                    ...
                                    <span
                                        class="bg-yellow-100 text-yellow-800 text-xs font-medium px-3 py-1 rounded-full">
                    {{ employee.currency }}
                  </span>
                                </div>
                            </div>
                        ...
                        <InfoSection title="Company & Hierarchy">
                            ...
                            <InfoItem label="Financial Company"
                                      :value="`${employee.fin_com_name} (ID: ${employee.fin_com_id})`"/>
                        ...
                        <div class="text-xs text-gray-500 border-t pt-4 mt-8 print:hidden">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                <div>Created by: {{ employee.created_by }} on {{
                                        formatDateTime(employee.created_at)
                                    }}
                                </div>
                                <div>Updated by: {{ employee.updated_by }} on {{
