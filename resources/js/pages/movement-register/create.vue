    ...
    >
        <div class="min-h-screen bg-gray-50 dark:bg-gray-950 py-8 px-4">
            <div class="max-w-5xl mx-auto">
                ...
                <div
                    ...
                    <div class="px-8 py-3 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex justify-center mt-1">
                                 <span
                                     class="px-5 py-2 text-red-600 bg-gray-100 dark:bg-gray-800 rounded-full text-sm font-medium border border-gray-300 dark:border-gray-600">
                    ...
                    <div class="p-8 lg:p-10">
                        <form @submit.prevent="submitForm" class="space-y-10">
                            ...
                            <!-- Visit For -->
                            <div
                                class="bg-white dark:bg-gray-900 rounded-xl p-7 border border-gray-200 dark:border-gray-700">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                                    <RadioOption
                                        v-model="form.visit_for"
                                        value="Customer"
                                        label="Customer Visit"
                                        class="border-2 border-gray-300 dark:border-gray-600 hover:border-blue-500 dark:hover:border-blue-400 transition-all"
                                    />
                                    <RadioOption
                                        v-model="form.visit_for"
                                        value="Development"
                                ...
                                <Transition name="fade">
                                    <div v-if="form.visit_for" class="mt-7 space-y-6">
                                        <div v-if="form.visit_for === 'Customer'">
                                            <FormSelect v-model="form.customer_id" label="Select Customer"
                                        ...
                                        <div v-else-if="form.visit_for === 'Development'">
                                            <FormInput v-model="form.development" label="Development Purpose"
                                                       placeholder="e.g. New fabric testing, supplier audit..."
                                                       required/>
                                        </div>
                      ...
                      Movement Started: {{ movement.start_time }}
                                    ...
                                    <div class="grid md:grid-cols-2 gap-6">
                                        <FormInput
                                            v-model="form.budgeted_bill"
                                            label="Budgeted Bill (BDT)"
                                            type="number"
                                            readonly
                                            class="bg-white dark:bg-gray-800"
                                        />
                                        <FormInput
                                            v-model="form.conveyance_bill"
                                            label="Actual Conveyance Bill (BDT)"
                                            type="number"
                                            required
                            ...
                            <div class="flex flex-col sm:flex-row gap-6 justify-center pt-10">
                                ...
                                <button
                                    ...
                                    type="button"
                                    @click="startMovement"
                                    class="px-12 py-4 bg-green-600 hover:bg-green-700 text-white font-bold text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3 justify-center"
                                >
                                    Start Movement
                                </button>
                                ...
                                <button
                                    ...
                                    type="button"
                                    @click="endMovement"
                                    class="px-12 py-4 bg-red-600 hover:bg-red-700 text-white font-bold text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3 justify-center"
                                >
                                    End Movement
                                </button>
                                ...
                                <button
                                    v-if="movement.ended"
                                    type="submit"
                                    class="px-14 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xl rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center gap-4 justify-center"
                                >
                                    Save Movement
                                </button>
                            </div>
                ...
                <span
                    class="inline-flex items-center gap-3 px-8 py-4 bg-gray-100 dark:bg-gray-800 rounded-full text-lg font-semibold border border-gray-300 dark:border-gray-600">
...
import {Clock, Play, Square, Save} from 'lucide-vue-next'
