      ...
      <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div class="flex items-center gap-3 w-full sm:w-auto">
            ...
            />
            <PerPageSelect v-model="props.perPage" @update:modelValue="updatePerPage" />
            <Link
              v-if="canCreate"
              href="/people/create"
      ...
      <div class="flex-1 overflow-hidden bg-white dark:bg-gray-800">
        ...
        <div class="sm:hidden h-full overflow-y-auto">
          <div
            ...
            :key="p.id"
            class="border-b border-gray-200 dark:border-gray-700 p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition"
          >
            <div class="flex items-center gap-3">
              ...
              <div class="flex gap-1">
                <Link v-if="canView" :href="`/people/${p.id}`" class="p-2 text-blue-600"><Eye class="w-5 h-5" /></Link>
                <Link v-if="canEdit" :href="`/people/${p.id}/edit`" class="p-2 text-yellow-600"><Edit class="w-5 h-5" /></Link>
                <DeleteDialog v-if="canDelete" :url="`/people/${p.id}`" record-name="Person" @deleted="handleDelete" />
              </div>
            </div>
