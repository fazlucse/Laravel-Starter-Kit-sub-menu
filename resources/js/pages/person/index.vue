...
<template>
  ...
  >
    <div class="flex flex-col h-[calc(100vh-5rem)]">
      ...
      <!-- Flash banner – auto-hide after 3 s -->
      <div
      ...
      <div
        v-if="selectedPerson"
        class="px-6 py-2 bg-green-50 dark:bg-green-900/30 text-sm text-green-800 dark:text-green-200"
      >
              ...
              >
                ...
                <td class="px-4 py-3 text-right">
                  <div class="flex justify-end gap-1">
                    <Link :href="`/people/${p.id}`" class="p-1.5 text-blue-600 hover:bg-blue-50 rounded">
                      <Eye class="w-4 h-4" />
                    </Link>
                    <Link :href="`/people/${p.id}/edit`" class="p-1.5 text-yellow-600 hover:bg-yellow-50 rounded">
                      <Edit class="w-4 h-4" />
                    </Link>
