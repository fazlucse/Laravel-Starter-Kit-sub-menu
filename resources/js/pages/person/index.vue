            ...
            <div class="p-2 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div class="flex items-center gap-3 w-full sm:w-auto">
                        <HelpModal
                            :doc="{
                            title: HELP_DOCS.people.title,
                            description: HELP_DOCS.people.description,
                            tips:HELP_DOCS.people.tips,
                            groups: HELP_DOCS.people.full_docs.groups
                          }"
                        />
                        <SearchPopup
                            v-model="search"
            ...
            <div class="flex-1 overflow-hidden bg-white dark:bg-gray-800">
                ...
                <div class="hidden sm:block h-full overflow-auto">
                        ...
                        >
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex justify-end gap-1">
                                    ...
                                    <Link v-if="canEdit" :href="`/people/${p.id}/edit`"
                                          class="p-1.5 text-yellow-600 hover:bg-yellow-50 dark:bg-yellow-900  rounded transition">
                                        <Edit class="w-4 h-4"/>
                                    </Link>
                                    <DeleteDialog
                                        v-if="canDelete"
                    ...
                    <div v-if="!people.data.length" class="text-center py-12 text-gray-500">
                        No people found.
                        <Link href="/people/create" class="text-blue-600 underline">Add one</Link>
                        .
                    </div>
                </div>
                    ...
                    >
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex gap-1">
                                <Link :href="`/people/${p.id}`" class="p-2 text-blue-600">
                                    <Eye class="w-5 h-5"/>
                                </Link>
                                <Link :href="`/people/${p.id}/edit`" class="p-2 text-yellow-600">
                                    <Edit class="w-5 h-5"/>
                                </Link>
