...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->foreign('company_id')->references('id')->on('companies'); // optional
            $table->foreign('division_id')->references('id')->on('divisions'); // optional
            $table->foreign('department_id')->references('department_id')->on('departments');
            $table->foreign('designation_id')->references('designation_id')->on('designations');
            $table->foreign('reporting_manager_id')->references('employee_id')->on('employees');
